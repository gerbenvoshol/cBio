/* libcbio/config.h.  Generated from config.h.in by configure.  */
/* libcbio/config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Name of package */
#define PACKAGE "libcbio"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "contact@gerbenvoshol.nl"

/* Define to the full name of this package. */
#define PACKAGE_NAME "libcbio"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "libcbio 0.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "libcbio"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://www.gerbenvoshol.nl/"
