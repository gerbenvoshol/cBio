           ...
           void (*draw)(short *, short *, PLINT))
{
	...
	for (i = 0; i < npts - 1; i++) {
		...
		if (drawable) {
			...
			crossed_xmin2 = (xx1 == xmin);
			crossed_xmax2 = (xx1 == xmax);
			crossed_ymin2 = (yy1 == ymin);
			crossed_ymax2 = (yy1 == ymax);
			...
			crossed_xmin1 = (xx2 == xmin);
			crossed_xmax1 = (xx2 == xmax);
			crossed_ymin1 = (yy2 == ymin);
			crossed_ymax1 = (yy2 == ymax);
		}
	}
